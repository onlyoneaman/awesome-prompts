---
title: "Burger King Selfie Asian Female"
description: "Photorealistic iPhone selfie of an East Asian woman in a Burger King restaurant, wearing a light grey fitted t-shirt and denim shorts. Casual evening moment with burger and fries, captured with natural restaurant lighting for an authentic social media aesthetic."
...
images: 
  ...
  - "/images/burger-king-selfie-asian-female/burger-king-selfie-asian-female-gemini-optimized.webp"
  - "/images/burger-king-selfie-asian-female/burger-king-selfie-asian-female-grok-1-optimized.webp"
  - "/images/burger-king-selfie-asian-female/burger-king-selfie-asian-female-grok-2-optimized.webp"
  - "/images/burger-king-selfie-asian-female/burger-king-selfie-asian-female-reference-optimized.webp"
use_cases: ["restaurant selfies", "lifestyle photography", "social media content", "photorealistic renders", "iPhone photography", "casual portraits", "fast food photography"]
...
```json
{
  ...
  "reference_usage": {
    ...
    "use_reference_for": [
      ...
      "overall slim-curvy physique",
      "natural fabric tension on clothing"
    ],
    "do_not_copy": [
      "face identity",
      "exact facial features",
      "specific person likeness"
    ],
  ...
  "scene": {
    ...
    "time": "evening",
    "environment": [
      "softly glowing menu boards in background",
      "fast food counter slightly out of focus",
      "tray with burger, fries and paper cup on table",
      "warm indoor fast-food lighting"
    ],
  ...
  "subject": {
    ...
    "body": {
      ...
      "waist": "narrow and feminine",
      "chest": "full and rounded, natural weight and volume",
      "ribcage": "petite, enhancing chest-to-waist contrast",
    ...
    "pose": {
      ...
      "hands": {
        "one_hand": "holding burger close to mouth",
        "other_hand": "resting casually on table"
      },
    ...
    "outfit": {
      "top": {
        ...
        "color": "light grey",
        "fabric": "thin cotton, slightly stretchy",
        "fit": "tight on chest, hugging waist",
        "length": "cropped just above navel",
        "underwear": "no bra",
        "fabric_behavior": "realistic stretch and tension similar to reference image"
      },
      "bottom": {
        "type": "short denim shorts",
        "color": "light blue",
        "length": "short, upper thigh",
        "fit": "snug but casual"
      }
    }
  },
